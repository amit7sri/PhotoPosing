        ...
        if (uri != null) {
            try {
               ...
               /* ByteArrayOutputStream baos = new ByteArrayOutputStream();
                ...
                //Firebase
                /*String path = "photoposer/" + UUID.randomUUID() +".png";
                StorageReference fbsref = storage.getReference(path);
                //StorageMetadata metadata = new StorageMetadata.Builder().setCustomMetadata("text", "").build();


                UploadTask uploadTask = fbsref.putFile(uri);
    ...
    private String convertResponseToString(BatchAnnotateImagesResponse response) {
        ...
        if (landmarks != null) {
            for (EntityAnnotation landmark : landmarks) {
                ...
                //new ServletPostAsyncTask().execute(new Pair<Context, String>(this, landmark.getDescription()));
                message.append("\n");
            }
        } else {
            message.append("nothing\n");
